                ...
                <div className="fixed inset-0 z-50 grid place-items-center bg-black/60 backdrop-blur-sm">
                    ...
                    <div className="w-full max-w-md rounded-lg bg-gray-900 border border-gray-800 p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <SelectCargo value={cargo} onChange={setCargo} />

                            <input type="number" placeholder="Percentual (%)" value={percentual} onChange={(e) => setPercentual(e.target.value)} className="input" />
